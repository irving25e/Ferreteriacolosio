...
import vista.FacturacionM;

public class VentaPDFG {
    ...
    public void generarFacturaPDF() {
        try {
            ...
            PdfPTable tablaMateriales = new PdfPTable(4);
            tablaMateriales.setWidthPercentage(100);
            tablaMateriales.getDefaultCell().setBorder(0);

            //tamaño de la celdas
            float[] ColumnaProducto = new float[]{15f, 50f, 15f, 20f};
            tablaMateriales.setWidths(ColumnaProducto);
            tablaMateriales.setHorizontalAlignment(Element.ALIGN_LEFT);
            ...
            //agg celda a la tabla 
            tablaMateriales.addCell(producto1);
            tablaMateriales.addCell(producto2);
            tablaMateriales.addCell(producto3);
            tablaMateriales.addCell(producto4);

            for(int i = 0;i< FacturacionM.jTable_materiales.getRowCount(); i++) {
                String producto = FacturacionM.jTable_materiales.getValueAt(i, 1).toString();
                String Cantidad = FacturacionM.jTable_materiales.getValueAt(i, 2).toString();
                String precio = FacturacionM.jTable_materiales.getValueAt(i, 3).toString();
                String total = FacturacionM.jTable_materiales.getValueAt(i, 7).toString();
               
                tablaMateriales.addCell(Cantidad);
                tablaMateriales.addCell(producto);
                tablaMateriales.addCell(precio);
                tablaMateriales.addCell(total);
            }
            ...
            info.add("Total a pagar: " + FacturacionM.txt_total_pagar.getText());
