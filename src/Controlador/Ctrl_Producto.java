...
public class Ctrl_Producto {
    ...
    public boolean guardar(producto objeto) {
        ...
        try {
            ...
            PreparedStatement consulta = cn.prepareStatement("insert into t_Productos values(?,?,?,?,?,?,?,?)");
    ...
    public boolean existeProducto(String producto) {
        boolean respuesta = false;
        String sql = "select Nombre from t_Productos where Nombre '" + producto + "';";
        Statement st;
    ...
    public boolean actualizar(producto objeto, int idProducto) {
        ...
        try {
            ...
            PreparedStatement consulta = cn.prepareStatement("update t_Productos set Nombre =?, Cantidad =?, precio =?, descripcion =?, porcentajeIva =?, idCategoria =?, estado =? where idProducto = '" + idProducto + "'");
    ...
    public boolean eliminar(int idProducto) {
        ...
        try {
            PreparedStatement consulta = cn.prepareStatement(
                    "delete from t_Productos where idProducto ='" + idProducto + "'");
