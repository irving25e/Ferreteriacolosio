...
public class Reportes {
    ...
    public void ReportesClientes() {
        ...
        try {
            ...
            Image header = Image.getInstance("src/Imagenes/image.jpg");
            header.scaleToFit(650, 1000);
            header.setAlignment(Chunk.ALIGN_CENTER);
            //formato al texto
            Paragraph parrafo = new Paragraph();
            parrafo.setAlignment(Paragraph.ALIGN_CENTER);
            parrafo.add("Reporte creado por \nIrving Mendoza © Programador\n\n");
            ...
            try {
                ...
                PreparedStatement pst = cn.prepareStatement(
                        "Select idCliente, concat(Nombre, ' ', Apellido) as nombres,cedula,telefono,direccion from t_clientes");
            ...
            try {
                ...
                PreparedStatement pst = cn.prepareStatement(
                        "select p.idProducto, p.Nombre, p.Cantidad, p.precio, p.descripcion, "
                                ...
                                + "from t_Productos as p, t_Categorias as c "
            ...
            try {
                ...
                PreparedStatement pst = cn.prepareStatement(
                        "select cv.idCabeceraVenta as id, concat(c.Nombre,' ',c.Apellido) as cliente, "
                                ...
                                + "from t_cabecera_venta as cv, t_clientes as c "
                                + "where cv.idCliente = cv.idCliente;");
                ResultSet rs = pst.executeQuery();
                if (rs.next()) {
                    do {
                        tabla.addCell(rs.getString(1));
