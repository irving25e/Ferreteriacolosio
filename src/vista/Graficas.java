...
import static vista.Responsable.JDesktopPane_Responsable;
...
public class Graficas extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jButton_Guardar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/spr_Guardar.png"))); // NOI18N
    ...
    private void jButton_GuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_GuardarActionPerformed
        ...
        GraficaVentas graficaventas = new GraficaVentas();
        JDesktopPane_Responsable.add(graficaventas);
        graficaventas.setVisible(true);
