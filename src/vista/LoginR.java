...
public class LoginR extends javax.swing.JFrame {
    ...
    public Image getIconImage() {
        Image retValue = Toolkit.getDefaultToolkit().getImage(ClassLoader.getSystemResource("Imagenes/12.png"));
        return retValue;
    }
    ...
    private void Login() {
        if (!Txt_Usuario.getText().isEmpty() && !Txt_Contraseña.getText().isEmpty()) {
            ...
            if (controlUsuario.LoginUser(usuario)) {
                //JOptionPane.showMessageDialog(null, "Logeado Correctamente! :D");
